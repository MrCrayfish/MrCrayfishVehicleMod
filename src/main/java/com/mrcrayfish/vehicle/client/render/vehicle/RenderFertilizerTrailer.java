 ...
 * Author: MrCrayfish
 */
public class RenderFertilizerTrailer extends RenderVehicle<EntityFertilizerTrailer, AbstractRenderVehicle<EntityFertilizerTrailer>>
{
    public RenderFertilizerTrailer(RenderManager renderManager)
    {
        super(renderManager, null);
    }

    @Override
    public void doRender(EntityFertilizerTrailer entity, double x, double y, double z, float currentYaw, float partialTicks)
    {
        ...
        GlStateManager.pushMatrix();
        {
            ...
            this.renderWheel(entity, -11.5F * 0.0625F, 0.3F, 0.0F, 2.0F, partialTicks);
            this.renderWheel(entity, 11.5F * 0.0625F, 0.3F, 0.0F, 2.0F, partialTicks);
            ...
            GlStateManager.pushMatrix();
            {
                GlStateManager.translate(0, 0.3, -0.4375);
