...
public class VehicleCrateRenderer extends TileEntityRenderer<VehicleCrateTileEntity>
{
    ...
    public void render(VehicleCrateTileEntity crate, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, int light, int overlay)
    {
        ...
        matrixStack.rotate(Vector3f.YP.rotationDegrees(facing.getHorizontalIndex() * -90F + 180F));
        matrixStack.translate(-0.5, -0.5, -0.5);
        ...
        for(int i = 0; i < 4; i++)
        {
            ...
            matrixStack.rotate(Vector3f.YP.rotationDegrees(90F * i));
            ...
            if(crate.isOpened())
            {
                ...
                matrixStack.rotate(Vector3f.XP.rotationDegrees((float) rotation * 90F));
            }
        ...
        if(crate.getEntity() != null && crate.isOpened())
        {
            ...
            if(crate.getTimer() >= 150)
            {
                ...
                matrixStack.rotate(Vector3f.YP.rotationDegrees((float) (720F * progress)));
            }
