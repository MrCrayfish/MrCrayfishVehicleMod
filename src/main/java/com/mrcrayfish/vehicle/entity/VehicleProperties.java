...
public class VehicleProperties
{
    ...
    public static void generateFiles()
    {
        ...
        serialize(ModEntities.GO_KART.get(), new VehicleProperties().setAxleOffset(-2.5F).setBodyPosition(new PartPosition(1.0)).setEnginePosition(new PartPosition(0, 2, -9, 0, 180, 0, 0.8)).setHeldOffset(new Vector3d(3.0D, 0.5D, 0.0D)).setTrailerOffset(new Vector3d(0D, -0.03125D, -0.375D)).setDisplayPosition(new PartPosition(0.0F, 0.0F, -0.15F, 0.0F, 0.0F, 0.0F, 1.5F)).addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 9.0F, 13.5F, 0.8F, false, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 9.0F, 13.5F, 0.8F, false, true).addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 9.0F, -8.5F, 0.8F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 9.0F, -8.5F, 0.8F, true, true).setFrontAxelVec(0, 13.5).setRearAxelVec(0, -8.5).addSeat(new Seat(new Vector3d(0, -2, -1), true)).setEngineType(EngineType.SMALL_MOTOR).setCanChangeWheels(true).setColored(true));
