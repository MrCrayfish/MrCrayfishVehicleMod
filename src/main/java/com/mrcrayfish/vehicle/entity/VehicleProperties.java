...
public class VehicleProperties
{
    ...
    public static void generateFiles()
    {
        ...
        serialize(ModEntities.ATV.get(), new VehicleProperties().setAxleOffset(-1.5F).setWheelOffset(4.375F).setBodyPosition(new PartPosition(1.25)).setFuelPortPosition(new PartPosition(0, 6.55, 5.0, -90, 0, 0, 0.35)).setKeyPortPosition(new PartPosition(-5, 4.5, 6.5, -45, 0, 0, 0.5)).setHeldOffset(new Vector3d(4.0, 3.5, 0.0)).setTowBarPosition(new Vector3d(0.0, 0.0, -20.8)).setTrailerOffset(new Vector3d(0.0, 0.0, -0.55)).setDisplayPosition(new PartPosition(1.5F)).addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 4.0F, 10.5F, 1.85F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 4.0F, 10.5F, 1.85F, true, true).addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 4.0F, -10.5F, 1.85F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 4.0F, -10.5F, 1.85F, true, true).setFrontAxelVec(0, 10.5).setRearAxelVec(0, -10.5).addSeat(new Seat(new Vector3d(0, 5, -3), true)).addSeat(new Seat(new Vector3d(0, 5.5, -12))).setEngineType(EngineType.SMALL_MOTOR).setCanChangeWheels(true).setColored(true));
        serialize(ModEntities.BUMPER_CAR.get(), new VehicleProperties().setAxleOffset(-1.5F).setWheelOffset(1.5F).setBodyPosition(new PartPosition(1.2)).setFuelPortPosition(new PartPosition(-8.0, 6, -8.0, 0, -90, 0, 0.25)).setHeldOffset(new Vector3d(6.0, 0.0, 0.0)).setTrailerOffset(new Vector3d(0.0, -0.03125, -0.5625)).setDisplayPosition(new PartPosition(1.5F)).addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 7.0F, 8.5F, 0.75F, false, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 7.0F, 8.5F, 0.75F, false, true).addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 7.0F, -8.5F, 0.75F, false, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 7.0F, -8.5F, 0.75F, false, true).setFrontAxelVec(0, 8.5).setRearAxelVec(0, -8.5).addSeat(new Seat(new Vector3d(0, 1, -6), true)).setEngineType(EngineType.ELECTRIC_MOTOR).setCanChangeWheels(true).setColored(true));
        serialize(ModEntities.DIRT_BIKE.get(), new VehicleProperties().setAxleOffset(0.0F).setWheelOffset(5.625F).setBodyPosition(new PartPosition(1.0)).setEnginePosition(new PartPosition(0, 1, 0, 0, 180, 0, 0.85)).setFuelPortPosition(new PartPosition(0, 12.1, 3, 67.5, 180, 0, 0.35)).setHeldOffset(new Vector3d(0.0, 3.5, 0.0)).setDisplayPosition(new PartPosition(1.4F)).setTrailerOffset(new Vector3d(0, -0.0625, -0.3125)).addWheel(Wheel.Side.NONE, Wheel.Position.FRONT, 0.0F, 0.0F, 14.08F, 1.5F, 2.25F, 2.25F, false, false).addWheel(Wheel.Side.NONE, Wheel.Position.REAR, 0.0F, 0.0F, -11.61F, 1.5F, 2.25F, 2.25F, true, true).setFrontAxelVec(0, 14.08).setRearAxelVec(0, -11.61).addSeat(new Seat(new Vector3d(0, 8, -2), true)).addSeat(new Seat(new Vector3d(0, 9, -9))).setEngineType(EngineType.SMALL_MOTOR).setCanChangeWheels(true).setColored(true));
        serialize(ModEntities.DUNE_BUGGY.get(), new VehicleProperties().setAxleOffset(-2.3F).setWheelOffset(2.5F).setBodyPosition(new PartPosition(1.3)).setFuelPortPosition(new PartPosition(0, 3, -7.0, 0, 180, 0, 0.25)).setHeldOffset(new Vector3d(2.0, 0.0, 0.0)).setTrailerOffset(new Vector3d(0.0, -0.025, -0.25)).setDisplayPosition(new PartPosition(1.75F)).addWheel(Wheel.Side.NONE, Wheel.Position.FRONT, 2.4F, 5.3F, 1.0F, false, false).addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 2.4F, -5.7F, 1.0F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 2.4F, -5.7F, 1.0F, true, true).setFrontAxelVec(0, 5.3).setRearAxelVec(0, -5.7).addSeat(new Seat(new Vector3d(0, 2, -3), true)).setEngineType(EngineType.SMALL_MOTOR).setCanChangeWheels(true));
        serialize(ModEntities.GO_KART.get(), new VehicleProperties().setAxleOffset(-2.5F).setWheelOffset(3.45F).setBodyPosition(new PartPosition(1.0)).setEnginePosition(new PartPosition(0, 2, -9, 0, 180, 0, 1.2)).setHeldOffset(new Vector3d(3.0D, 0.5D, 0.0D)).setTrailerOffset(new Vector3d(0D, -0.03125D, -0.375D)).setDisplayPosition(new PartPosition(0.0F, 0.0F, -0.15F, 0.0F, 0.0F, 0.0F, 1.5F)).addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 9.0F, 13.5F, 1.0F, false, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 9.0F, 13.5F, 1.0F, false, true).addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 9.0F, -8.5F, 1.0F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 9.0F, -8.5F, 1.0F, true, true).setFrontAxelVec(0, 13.5).setRearAxelVec(0, -8.5).addSeat(new Seat(new Vector3d(0, -2, -1), true)).setEngineType(EngineType.SMALL_MOTOR).setCanChangeWheels(true).setColored(true));
        serialize(ModEntities.GOLF_CART.get(), new VehicleProperties().setAxleOffset(-0.5F).setWheelOffset(4.45F).setBodyPosition(new PartPosition(1.15)).setFuelPortPosition(new PartPosition(-13, 3.5, -6, 0, -90, 0, 0.25)).setKeyPortPosition(new PartPosition(-8.5, 2.75, 8.5, -67.5, 0, 0, 0.5)).setHeldOffset(new Vector3d(1.5D, 2.5D, 0.0D)).setDisplayPosition(new PartPosition(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.25F)).addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 9.0F, 16.0F, 1.75F, false, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 9.0F, 16.0F, 1.75F, false, true).addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 9.0F, -12.5F, 1.75F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 9.0F, -12.5F, 1.75F, true, true).setFrontAxelVec(0, 16.0).setRearAxelVec(0, -12.5).addSeat(new Seat(new Vector3d(5.5, 5, -6), true)).addSeat(new Seat(new Vector3d(-5.5, 5, -6))).addSeat(new Seat(new Vector3d(5.5, 5, -15), 180F)).addSeat(new Seat(new Vector3d(-5.5, 5, -15), 180F)).setEngineType(EngineType.ELECTRIC_MOTOR).setCanChangeWheels(true).setColored(true));
        serialize(ModEntities.JET_SKI.get(), new VehicleProperties().setWheelOffset(2.75F).setBodyPosition(new PartPosition(0.0, 0.0, 0.25, 0.0, 0.0, 0.0, 1.25)).setFuelPortPosition(new PartPosition(0.0, 9.25, 8.5, -90, 0, 0, 0.35)).setHeldOffset(new Vector3d(6.0, 0.0, 0.0)).setTrailerOffset(new Vector3d(0.0, -0.09375, -0.65)).setDisplayPosition(new PartPosition(0.0F, 0.0F, -0.45F, 0.0F, 0.0F, 0.0F, 1.5F)).addSeat(new Seat(new Vector3d(0, 5, 0), true)).addSeat(new Seat(new Vector3d(0, 5, -7))).setEngineType(EngineType.SMALL_MOTOR).setColored(true));
        serialize(ModEntities.LAWN_MOWER.get(), new VehicleProperties().setAxleOffset(-2.0F).setWheelOffset(2.85F).setBodyPosition(new PartPosition(1.25)).setFuelPortPosition(new PartPosition(-4.50, 9.5, 4.0, 0, -90, 0, 0.2)).setKeyPortPosition(new PartPosition(-5, 4.5, 6.5, -45, 0, 0, 0.5)).setHeldOffset(new Vector3d(12.0, -1.5, 0.0)).setTowBarPosition(new Vector3d(0.0, 0.0, -20.0)).setTrailerOffset(new Vector3d(0.0, -0.01, -1.0)).setDisplayPosition(new PartPosition(1.5F)).addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 6.0F, 0.0F, 13.5F, 1.15F, false, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 6.0F, 0.0F, 13.5F, 1.15F, false, true).addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 5.0F, 0.8F, -10.7F, 1.55F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 5.0F, 0.8F, -10.7F, 1.55F, true, true).setFrontAxelVec(0, 13.5).setRearAxelVec(0, -10.7).addSeat(new Seat(new Vector3d(0, 7, -9), true)).setEngineType(EngineType.SMALL_MOTOR).setCanChangeWheels(true).setColored(true));
        serialize(ModEntities.MINI_BIKE.get(), new VehicleProperties().setAxleOffset(-1.7F).setWheelOffset(4.0F).setBodyPosition(new PartPosition(1.05)).setEnginePosition(new PartPosition(0, 1, 2.5, 0, 180F, 0, 1.0)).setHeldOffset(new Vector3d(6.0, 0.0, 0.0)).setTrailerOffset(new Vector3d(0.0, -0.0625, -0.5)).setDisplayPosition(new PartPosition(0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 1.5F)).addWheel(Wheel.Side.NONE, Wheel.Position.REAR, 0.0F, -6.7F, 1.65F, true, true).addWheel(Wheel.Side.NONE, Wheel.Position.FRONT, 0.0F, -0.5F + 1.7F * 0.0625F, 13.0F, 1.65F, true, false).setFrontAxelVec(0, 13).setRearAxelVec(0, -6.7).addSeat(new Seat(new Vector3d(0, 7, -2), true)).setEngineType(EngineType.SMALL_MOTOR).setCanChangeWheels(true).setColored(true));
        serialize(ModEntities.MINI_BUS.get(), new VehicleProperties().setAxleOffset(1.0F).setWheelOffset(4.5F).setBodyPosition(new PartPosition(1.3)).setFuelPortPosition(new PartPosition(-12.0, 8.0, -8.75, 0, -90, 0, 0.25)).setKeyPortPosition(new PartPosition(0, 6.75, 19.5, -67.5, 0, 0, 0.5)).setHeldOffset(new Vector3d(0.0, 3.5, 0.0)).setTowBarPosition(new Vector3d(0.0, 0.0, -33.0)).setDisplayPosition(new PartPosition(1.0F)).addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 9.0F, 0.0F, 13.5F, 1.5F, 1.9F, 1.9F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 9.0F, 0.0F, 13.5F, 1.5F, 1.9F, 1.9F, true, true).addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 9.0F, 0.0F, -13.5F, 1.5F, 1.9F, 1.9F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 9.0F, 0.0F, -13.5F, 1.5F, 1.9F, 1.9F, true, true).setFrontAxelVec(0, 14.5).setRearAxelVec(0, -14.5).addSeat(new Seat(new Vector3d(4.5, 2, 11), true)).addSeat(new Seat(new Vector3d(-4.5, 2, 11))).addSeat(new Seat(new Vector3d(4.5, 2, -3))).addSeat(new Seat(new Vector3d(-4.5, 2, -3))).addSeat(new Seat(new Vector3d(4.5, 2, -15))).setEngineType(EngineType.LARGE_MOTOR).setCanChangeWheels(true).setColored(true));
        serialize(ModEntities.MOPED.get(), new VehicleProperties().setAxleOffset(-1.0F).setWheelOffset(3.2F).setBodyPosition(new PartPosition(1.2)).setFuelPortPosition(new PartPosition(-2.5, 4.2, -1.5, 0, -90, 0, 0.2)).setHeldOffset(new Vector3d(4.5, 2.0, 0.0)).setTrailerOffset(new Vector3d(0.0, -0.03125, -0.65)).setDisplayPosition(new PartPosition(0.0F, 0.0F, -0.25F, 0.0F, 0.0F, 0.0F, 1.5F)).addWheel(Wheel.Side.NONE, Wheel.Position.REAR, 0.0F, -6.7F, 0.8F, true, true).addWheel(Wheel.Side.NONE, Wheel.Position.FRONT, 0.0F, 0.0F, 14.0884F, 0.6F, 0.8F, 0.8F, true, false).setFrontAxelVec(0, 14.5).setRearAxelVec(0, -6.7).addSeat(new Seat(new Vector3d(0, 4, -1), true)).setEngineType(EngineType.SMALL_MOTOR).setCanChangeWheels(true).setColored(true));
        serialize(ModEntities.OFF_ROADER.get(), new VehicleProperties().setAxleOffset(-1.0F).setWheelOffset(5.4F).setBodyPosition(new PartPosition(1.4)).setFuelPortPosition(new PartPosition(-12.0, 8.5, -6.5, 0, -90, 0, 0.25)).setKeyPortPosition(new PartPosition(0, 7, 6.2, -67.5, 0, 0, 0.5)).setHeldOffset(new Vector3d(0.0, 3.5, 0.0)).setDisplayPosition(new PartPosition(0.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.0F, 1.0F)).addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 10.0F, 14.5F, 2.25F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 10.0F, 14.5F, 2.25F, true, true).addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 10.0F, -14.5F, 2.25F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 10.0F, -14.5F, 2.25F, true, true).setFrontAxelVec(0, 14.5).setRearAxelVec(0, -14.5).addSeat(new Seat(new Vector3d(5, 4, -3), true)).addSeat(new Seat(new Vector3d(-5, 4, -3))).addSeat(new Seat(new Vector3d(5, 11.5, -14.5))).addSeat(new Seat(new Vector3d(-5, 3.5, -18.9))).setEngineType(EngineType.LARGE_MOTOR).setCanChangeWheels(true).setColored(true));
        serialize(ModEntities.SHOPPING_CART.get(), new VehicleProperties().setAxleOffset(-1.0F).setWheelOffset(2.0F).setBodyPosition(new PartPosition(1.05)).setHeldOffset(new Vector3d(4.0, 9.25, 0.0)).setTrailerOffset(new Vector3d(0.0, -0.03125, -0.25)).setDisplayPosition(new PartPosition(1.45F)).addWheel(Wheel.Side.LEFT, Wheel.Position.NONE, 5.75F, -10.5F, 0.75F, false, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.NONE, 5.75F, -10.5F, 0.75F, false, true).addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 4.0F, 9.5F, 0.75F, false, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 4.0F, 9.5F, 0.75F, false, true).setFrontAxelVec(0, 9.5).setRearAxelVec(0, -10.5).addSeat(new Seat(new Vector3d(0, 7, -4), true)).setEngineType(EngineType.NONE).setCanChangeWheels(true));
        serialize(ModEntities.SMART_CAR.get(), new VehicleProperties().setAxleOffset(-1.7F).setWheelOffset(3.5F).setBodyPosition(new PartPosition(1.25)).setFuelPortPosition(new PartPosition(-9.0, 8.7, -12.3, 0, -90, 0, 0.25)).setHeldOffset(new Vector3d(3.0, 1.0, 0.0)).setTowBarPosition(new Vector3d(0.0, 0.0, -24.5)).setDisplayPosition(new PartPosition(1.35F)).addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 7F, 12F, 1.5F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 7F, 12F, 1.5F, true, true).addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 7F, -12F, 1.5F, false, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 7F, -12F, 1.5F, false, true).setFrontAxelVec(0, 12).setRearAxelVec(0, -12).addSeat(new Seat(new Vector3d(0, 0.5, -2), true)).setEngineType(EngineType.ELECTRIC_MOTOR).setCanChangeWheels(true).setColored(true));
        serialize(ModEntities.SPEED_BOAT.get(), new VehicleProperties().setWheelOffset(2.5F).setBodyPosition(new PartPosition(0.0, -0.03125, 0.6875, 1.0)).setFuelPortPosition(new PartPosition(0.0, 5.25, -20.5, -90.0, 0.0, 0.0, 0.65)).setHeldOffset(new Vector3d(6.0, -0.5, 0.0)).setTrailerOffset(new Vector3d(0.0, -0.09375, -0.75)).setDisplayPosition(new PartPosition(0.0F, 0.0F, -0.65F, 0.0F, 0.0F, 0.0F, 1.25F)).addSeat(new Seat(new Vector3d(0, 0, 0), true)).setEngineType(EngineType.LARGE_MOTOR).setColored(true));
        ...
        serialize(ModEntities.TRACTOR.get(), new VehicleProperties().setAxleOffset(-3.0F).setWheelOffset(5.5F).setBodyPosition(new PartPosition(1.0)).setEnginePosition(new PartPosition(0, 6, 8.775, 0, 0, 0, 0.85)).setFuelPortPosition(new PartPosition(-6.0, 9.5, -0.5, 0, -90, 0, 0.3)).setKeyPortPosition(new PartPosition(-2.75, 12, -1.75, -45.0, 0, 0, 0.5)).setHeldOffset(new Vector3d(0.0, 3.5, 0.0)).setTowBarPosition(new Vector3d(0.0, 0.0, -24.5)).setDisplayPosition(new PartPosition(1.25F)).addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 8.0F, 0.0F, 14.0F, 1.5F, 2.25F, 2.25F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 8.0F, 0.0F, 14.0F, 1.5F, 2.25F, 2.25F, true, true).addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 8.0F, 5.5F, -14.5F, 3.0F, 4.5F, 4.5F, true, true).addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 8.0F, 5.5F, -14.5F, 3.0F, 4.5F, 4.5F, true, true).setFrontAxelVec(0, 14.0).setRearAxelVec(0, -14.5).addSeat(new Seat(new Vector3d(0, 9, -14), true)).setEngineType(EngineType.LARGE_MOTOR).setCanChangeWheels(true).setColored(true));
    ...
    public static class Serializer implements JsonDeserializer<VehicleProperties>, JsonSerializer<VehicleProperties>
    {
        ...
        public JsonElement serialize(VehicleProperties src, Type typeOfSrc, JsonSerializationContext context)
        {
            ...
            if(src.wheelOffset != 0) axles.addProperty("wheelOffset", src.wheelOffset);
