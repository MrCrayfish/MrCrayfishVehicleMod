    ...
    public void registerProperties()
    {
        ...
        this.add(ModEntities.SPORTS_CAR.get(), VehicleProperties.builder()
                ...
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.SEAT)
                        ...
                        .setOffset(0, 1.0, 0))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.DASHBOARD)
                        .addModelLocation(SpecialModels.SPORTS_CAR_COSMETIC_DASHBOARD.getModelLocation())
                        .setOffset(0, 14.0, 12.0))
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.ROOF)
                        .addModelLocation(SpecialModels.SPORTS_CAR_COSMETIC_ROOF.getModelLocation())
                        .setOffset(0, 14.0, 0)));
        ...
        this.add(ModEntities.SPORTS_PLANE.get(), VehicleProperties.builder()
                ...
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.WINGS)
                        .addModelLocation(SpecialModels.SPORTS_PLANE_WINGS.getModelLocation())
                        .setOffset(0, 20, -7)
                        .build())
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.SEAT)
                        .addModelLocation(SpecialModels.SPORTS_PLANE_SEAT.getModelLocation())
                        .setOffset(0, 8, 0)
                        .build())
