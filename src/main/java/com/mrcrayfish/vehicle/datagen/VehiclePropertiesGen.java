    ...
    protected void registerProperties()
    {
        this.add(ModEntities.ATV.get(), VehicleProperties.builder()
                ...
                .addExtended(PoweredProperties.builder()
                        ...
                        .setEnginePower(15F)
                        .setFuelFillerTransform(Transform.create(0.0, 9.0, 5.0, -90.0, 0.0, 0.0, 0.6))
        ...
        this.add(ModEntities.MINI_BUS.get(), VehicleProperties.builder()
                ...
                .addExtended(PoweredProperties.builder()
                        ...
                        .build())
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.TOP_DECOR)
                        .setOffset(0, 13, 0)
                ...
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.REAR_DECOR)
                        .setOffset(0, 6, -22.0)
