    ...
    protected void registerProperties()
    {
        ...
        this.add(ModEntities.MINI_BUS.get(), VehicleProperties.builder()
                ...
                .addExtended(PoweredProperties.builder()
                        ...
                        .build())
                .addCosmetic(CosmeticProperties.builder(new ResourceLocation("vehicle:top"))
                        .setOffset(0, 13, 0)
                        .addModelLocation(SpecialModels.MINI_BUS_COSMETIC_STOCK_ROOF.getModelLocation()))
                .addCosmetic(CosmeticProperties.builder(new ResourceLocation("vehicle:roof"))
                        .setOffset(0, 22, 0)
                ...
                .addCosmetic(CosmeticProperties.builder(new ResourceLocation("vehicle:right_door"))
                        ...
                        .addAction(new OpenableAction(OpenableAction.Axis.Y, 75F, new ResourceLocation("vehicle:entity.vehicle.door.open"), new ResourceLocation("vehicle:entity.vehicle.door.close"), 12)))
                .addCosmetic(CosmeticProperties.builder(new ResourceLocation("vehicle:left_sliding_door"))
                ...
                .addCosmetic(CosmeticProperties.builder(new ResourceLocation("vehicle:rear_decor"))
                        .setOffset(0, 6, -22.0)
