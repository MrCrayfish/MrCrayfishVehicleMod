...
public class ModItems
{
    ...
    public static final RegistryObject<Item> WOOD_SMALL_ENGINE = register("wood_small_engine", new EngineItem(EngineType.SMALL_MOTOR, EngineTier.WOOD, new Item.Properties().tab(VehicleMod.CREATIVE_TAB)));
    public static final RegistryObject<Item> STONE_SMALL_ENGINE = register("stone_small_engine", new EngineItem(EngineType.SMALL_MOTOR, EngineTier.STONE, new Item.Properties().tab(VehicleMod.CREATIVE_TAB)));
    ...
    public static final RegistryObject<Item> WOOD_LARGE_ENGINE = register("wood_large_engine", new EngineItem(EngineType.LARGE_MOTOR, EngineTier.WOOD, new Item.Properties().tab(VehicleMod.CREATIVE_TAB)));
    public static final RegistryObject<Item> STONE_LARGE_ENGINE = register("stone_large_engine", new EngineItem(EngineType.LARGE_MOTOR, EngineTier.STONE, new Item.Properties().tab(VehicleMod.CREATIVE_TAB)));
    ...
    public static final RegistryObject<Item> WOOD_ELECTRIC_ENGINE = register("wood_electric_engine", new EngineItem(EngineType.ELECTRIC_MOTOR, EngineTier.WOOD, new Item.Properties().tab(VehicleMod.CREATIVE_TAB)));
    public static final RegistryObject<Item> STONE_ELECTRIC_ENGINE = register("stone_electric_engine", new EngineItem(EngineType.ELECTRIC_MOTOR, EngineTier.STONE, new Item.Properties().tab(VehicleMod.CREATIVE_TAB)));
    ...
    public static final RegistryObject<Item> JERRY_CAN = register("jerry_can", new JerryCanItem(5000, 100, new Item.Properties().stacksTo(1).tab(VehicleMod.CREATIVE_TAB)));
    public static final RegistryObject<Item> INDUSTRIAL_JERRY_CAN = register("industrial_jerry_can", new JerryCanItem(15000, 150, new Item.Properties().stacksTo(1).tab(VehicleMod.CREATIVE_TAB)));
