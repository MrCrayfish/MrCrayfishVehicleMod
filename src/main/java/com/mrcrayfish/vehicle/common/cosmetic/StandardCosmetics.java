...
public final class StandardCosmetics
{
    ...
    public static final ResourceLocation DASHBOARD = new ResourceLocation(Reference.MOD_ID, "dashboard");
    public static final ResourceLocation TRAY = new ResourceLocation(Reference.MOD_ID, "tray");
    public static final ResourceLocation FRONT_LIGHTS = new ResourceLocation(Reference.MOD_ID, "front_lights");
    public static final ResourceLocation REAR_LIGHTS = new ResourceLocation(Reference.MOD_ID, "rear_lights");
    public static final ResourceLocation FRONT_BUMPER = new ResourceLocation(Reference.MOD_ID, "front_bumper");
