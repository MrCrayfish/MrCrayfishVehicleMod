...
import net.hdt.hva.entity.vehicle.EntityMotorcycle;
 ...
 * Author: MrCrayfish
 */
public class RenderMotorcycle extends RenderLandVehicle<EntityMotorcycle>
{
    public RenderMotorcycle(RenderManager renderManager)
    {
        super(renderManager);
    ...
    @Override
    public void doRender(EntityMotorcycle entity, double x, double y, double z, float currentYaw, float partialTicks)
    {
