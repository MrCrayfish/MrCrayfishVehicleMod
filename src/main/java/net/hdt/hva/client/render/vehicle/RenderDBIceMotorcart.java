...
public class RenderDBIceMotorcart extends RenderLandVehicle<EntityDBIceMotorcart> {

    public RenderDBIceMotorcart(RenderManager renderManager) {
        super(renderManager);
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityDBIceMotorcart entity)
    {
        return null;
    }

    @Override
    public void doRender(EntityDBIceMotorcart entity, double x, double y, double z, float currentYaw, float partialTicks)
    {
