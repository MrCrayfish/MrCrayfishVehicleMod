 ...
 * Author: MrCrayfish
 */
public class RenderSleight extends RenderVehicle<EntitySleight>
{
    public RenderSleight(RenderManager renderManager)
    {
        super(renderManager);
    }
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntitySleight entity)
    {
        return null;
    }

    @Override
    public void doRender(EntitySleight entity, double x, double y, double z, float currentYaw, float partialTicks)
    {
        ...
        GlStateManager.pushMatrix();
        {
            ...
            GlStateManager.pushMatrix();
            {
                GlStateManager.translate(0, bodyLevelToGround + bodyOffset, 0.4);
