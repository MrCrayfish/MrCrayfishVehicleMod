...
import net.hdt.hva.entity.vehicle.EntityBMXBike;
 ...
 * Author: MrCrayfish
 */
public class RenderBMXBike extends RenderLandVehicle<EntityBMXBike>
{
    public RenderBMXBike(RenderManager renderManager)
    {
        super(renderManager);
    ...
    @Override
    public void doRender(EntityBMXBike entity, double x, double y, double z, float currentYaw, float partialTicks)
    {
