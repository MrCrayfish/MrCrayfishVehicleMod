 ...
 * Author: MrCrayfish
 */
public class RenderSantaSleight extends RenderVehicle<EntitySantaSleight>
{
    public RenderSantaSleight(RenderManager renderManager)
    {
        super(renderManager);
    }
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntitySantaSleight entity)
    {
        return null;
    }

    @Override
    public void doRender(EntitySantaSleight entity, double x, double y, double z, float currentYaw, float partialTicks)
    {
        ...
        GlStateManager.pushMatrix();
        {
            ...
            GlStateManager.pushMatrix();
            {
                GlStateManager.translate(0, bodyLevelToGround + bodyOffset, -0.05);
