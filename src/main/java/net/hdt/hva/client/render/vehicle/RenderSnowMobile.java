...
import net.hdt.hva.entity.vehicle.EntitySnowMobile;
 ...
 * Author: MrCrayfish
 */
public class RenderSnowMobile extends RenderLandVehicle<EntitySnowMobile>
{
    public RenderSnowMobile(RenderManager renderManager)
    {
        super(renderManager);
//        this.setEnginePosition(0F, 7.25F, 3F, 180F, 1.0F);
//        this.wheels.add(new Wheel(Wheel.Side.NONE, Wheel.Position.REAR, 0F, 0.0f, -6.7F, 1.65F));
    }

    @Override
    public void doRender(EntitySnowMobile entity, double x, double y, double z, float currentYaw, float partialTicks)
    {
        ...
        GlStateManager.pushMatrix();
        {
            ...
            GlStateManager.scale(1.65, 1.65, 1.65);
            ...
            GlStateManager.pushMatrix();
            {
                GlStateManager.translate(0, 0.3 * 0.0625, 0);
            ...
            GlStateManager.pushMatrix();
            {
                ...
                float turnRotation = wheelAngleNormal * 12.5F;
                ...
                GlStateManager.pushMatrix();
                {
                    GlStateManager.translate(0, 0, 13 * 0.0625);
