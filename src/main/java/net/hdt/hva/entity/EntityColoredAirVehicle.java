 ...
 * Author: MrCrayfish
 */
public abstract class EntityColoredAirVehicle extends EntityAirVehicle
{
    protected static final DataParameter<Integer> COLOR = EntityDataManager.createKey(EntityColoredAirVehicle.class, DataSerializers.VARINT);

    protected EntityColoredAirVehicle(World worldIn)
    {
        super(worldIn);
    }
